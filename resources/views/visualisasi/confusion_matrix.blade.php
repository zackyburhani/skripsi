...
<section class="content-header">
    <h1>
        <i class="fa fa-bar-chart"></i> Confusion Matrix
    </h1>
    <ol class="breadcrumb">
        <li><a href="/confusion-matrix"><i class="fa fa-bar-chart"></i> Confusion Matrix</a></li>
    </ol>
</section>
...
<script src="{{asset('js/confusion_matrix.js')}}"></script>
@endsection