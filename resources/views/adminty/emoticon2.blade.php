                                ...
                                <div class="card-block">
                                    <form id="frmEmoticon" name="frmEmoticon">  
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Emoticon</label>
                                            <div class="col-sm-6">
                                                <input type="text" placeholder="Masukkan Simbol Emoticon" name="emoticon" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
